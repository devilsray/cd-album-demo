            ...
            $
                .each(
                    ...
                    function(index, value) {
                      var tbl_row = "<td align=\"center\"><a class=\"btn btn-default\" onclick=\"editArtist('" + encodeURI(value._links.self.href) + "')\" data-toggle=\"modal\" data-target=\"#myModal\"><em class=\"glyphicon glyphicon-pencil\" onclick=\"setModal('/artist-edit.html', 'Künstler anlegen', '/articles/1')\"></em></a>";
                      ...
                      tbl_row += "<td class=\"hidden\" onclick=\"setModal('/artist-edit.html', 'Künstler anlegen', '/articles')\">"
